...
ggplot(subset(coa_courses3, Department_combined != "SG" & Department_combined != "GS"), aes(x = Semester, fill = Department_combined)) +
  geom_bar() +
  labs(
...
ggplot(subset(coa_courses3, Department_combined != "SG" & Department_combined != "GS"), aes(x = Semester, y = after_stat(count), group = Department_combined, color = Department_combined)) +
