...
coa_courses <- coa_courses %>%
  mutate(Year = str_c(20, str_extract(Semester, "\\d{2}")),
         ...
         Lab_Fee_Text = str_extract(CourseDescription, pattern = "(?<=Lab fee\\:|Lab Fee\\:|Lab fee \\$|Lab Fee \\$|Course fee\\:|Course Fee\\:|Course fee \\$|Program fee\\:|)[^.]+"),
...
ggplot(subset(coa_courses3, Department_combined != "SG" & Department_combined != "GS"), aes(x = fct_relevel(Year_Term, c("18WI", "18SP",
        "18FA", "19WI", "19SP",
        "19FA", "20WI", "20SP",
        "20FA", "21WI", "21SP",
        "21FA", "22WI", "22SP",
        "22FA", "23WI", "23SP")), fill = fct_relevel(Department_combined, c("MD", "ED","AD", "ES", "HS" )))) +
  geom_bar() +
   scale_fill_brewer(palette = "Spectral") +
  labs(
...
ggplot(subset(coa_courses3, Department_combined != "SG" & Department_combined != "GS"), aes(x = Year_Term, y = after_stat(count), group = Department_combined, color = Department_combined)) +
