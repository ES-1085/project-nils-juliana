...
coa_courses3$Academic_Year_Term <- paste0(coa_courses3$Year, coa_courses3$Term)
coa_courses3$Academic_Year_Term <- substring(coa_courses3$Academic_Year_Term, 3)
...
ggplot(subset(coa_courses3, Department_combined != "SG" & Department_combined != "GS"), aes(x = Academic_Year_Term, fill = Department_combined)) +
  geom_bar() +
  labs(
...
ggplot(subset(coa_courses3, Department_combined != "SG" & Department_combined != "GS"), aes(x = Academic_Year_Term, y = after_stat(count), group = Department_combined, color = Department_combined)) +
